...
if ($havePost) {
   ...
   if ($errors != '') {
      ...
      if ($dbOk) {
         ...
         $insQuery = "insert into actors (`last_name`,`first_names`,`dob`) values(?,?,?)";//actors=table name, last_names,etc.. field names
...
<table id="actorTable">
   ...
   if ($dbOk) {
      ...
      $query = 'select * from actors order by last_name';//all fields=*
